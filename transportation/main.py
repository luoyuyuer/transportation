...
bad_dispose.car_set(link.date_1_list, 1)
bad_dispose.car_set(link.date_2_list, 2)
...
# 得到单一列表仅存一种车辆
list_1_dict, car1_count_list, data1_value = bad_dispose.car_count(bad_dispose.date_1_set, link.date_1_list, 1)
# list_2_dict, car2_count_list, data2_value = bad_dispose.car_count(bad_dispose.date_2_set, link.date_2_list, 2)
